...
it('should return 404 if details Not Found', (done) => {
  ...
  it('should return 404 for non-object ids', (done) => {
    ...
    //Update Test Unit
    describe('PATCH/details/:id', ()=>{
      it('it Shoudl Update a course Record by Id', (done)=>{
        var hexId = details[0]._id.toHexString();
        var fname = "New Name ....firstname";
        ...
        .expect(200)
        .expect((res) =>{
          expect(res.body.details.firstname).toBe(fname);
          expect(res.body.details.lastname).toBe(lname);
          expect(res.body.details.age).toBe(n_age);
